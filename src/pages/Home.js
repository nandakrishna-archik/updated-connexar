...
import img14 from "./../assets/bg image.png";
  ...
  return (
    <>
      ...
      <div className="main">
        {/* Home page Banner */}
        <div
          className="position-relative hm_bg overflow-hidden p-3 text-center"
          style={{ backgroundImage: `url(${HomebgImage})` }}
        >
          <div
            data-aos="fade-up"
            data-aos-duration="3000"
            className="col-md-12 p-lg-5 mx-auto my-5 hero_cnt"
          >
          ...
          <div className="container ">
            <div className="row">
              <div className="col-sm-6 d-flex align-items-center">
                <h5 className="mb-0 text-white"><b>Open Your Account </b></h5>
              </div>
              <div className="col-sm-6 text-right">
                <button className="btn crt_n"><b>Create now !</b></button>
              </div>
            </div>
          </div>
        </section>
              ...
              <div className="col-md-6 mt-3">
                <div className="card w-75 m-auto">
                  <div className="card-body">
                    ...
                    <div className="cont-card">
                      <b> <h4>INDICES</h4>
                      <p>20 index CFDs ,including CFDs and Index Futures.</p></b>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-6 mt-3">
                <div className="card w-75 m-auto">
                  <div className="card-body">
                    ...
                    <div className="cont-card">
                      <b> <h4>CRYPTOS</h4>
                      <p>Top 10 Tradable CRYPTOS brings more.</p></b>
                    </div>
                  </div>
                </div>
              </div>
